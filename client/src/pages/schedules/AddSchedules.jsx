    ...
    const onClickGenerateSchedules = async () => {
        ...
        try {
            ...
            for (let day = 1; day <= totalDays; day++) {
                console.log("log2:")
                const dailyPlanResponse = await fetch(`https://52.78.2.148:80/api/schedules/${scheduleId}/dailyplans`, {
                    method: "POST",
                    headers: {
                        "Authorization": accessToken,
                        "Content-Type": "application/json"
                ...
                for (const location of cardLocations[day - 1] || []) {
                    ...
                    // Place 생성
                    const placeResponse = await fetch("https://52.78.2.148:80/api/place", {
                        method: "POST",
                        headers: {
                            "Authorization": accessToken,
                            "Content-Type": "application/json"
                    ...
                    // Marker 생성
                    const markerResponse = await fetch(`https://52.78.2.148:80/api/daily-plans/${dailyPlanId}/place/${placeId}/markers`, {
                        method: "POST",
                        headers: {
                            "Authorization": accessToken,
                            "Content-Type": "application/json"
